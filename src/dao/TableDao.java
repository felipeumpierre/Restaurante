...
public interface TableDao {
   ...
   static final String INSERT = "INSERT INTO restaurante.table (number, capacity, created_at) VALUES(?, ?, ?);";
   static final String UPDATE = "UPDATE restaurante.table SET capacity = ?, number = ?, status = ? WHERE id = ?;";
}
